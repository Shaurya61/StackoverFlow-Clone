...
const Chatbot = ({ setIsOpen, isVerified, setIsVerified }) => {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stackoverflow-clone-7163.onrender.com/otp/sendOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleOTPSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stackoverflow-clone-7163.onrender.com/otp/verifyOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
